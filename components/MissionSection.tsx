...
const MissionSection: React.FC = () => {
    return (
        <section className="py-24 px-6 max-w-5xl mx-auto text-center" id="about">
            ...
            <h3 className="text-4xl md:text-5xl font-black text-slate-900 dark:text-white mb-8">From Consumer to Contributor</h3>
            <p className="text-xl text-slate-600 dark:text-slate-300 leading-relaxed mb-12">
                ...
                ETH Research Village is designed to foster a robust <span className="text-slate-900 dark:text-white font-semibold italic">Core Dev and Research culture</span>,
