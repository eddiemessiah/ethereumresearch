            ...
            <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
                <div className="space-y-8">
                    <div>
                        ...
                        <h3 className="text-4xl font-black text-slate-900">Beyond the Consumer Horizon</h3>
                    </div>
                    ...
                    <div className="grid sm:grid-cols-2 gap-8">
                        <div className="space-y-3">
                            ...
                            <h4 className="text-slate-900 font-bold">Deep Research</h4>
                            <p className="text-sm text-slate-500">Moving past the 48-hour hackathon model into month-long deep dives into EIPs and protocol design.</p>
                        </div>
                        <div className="space-y-3">
                            <div className="w-10 h-10 rounded-lg bg-[#13ec5b]/10 flex items-center justify-center text-[#13ec5b]">
                                <span className="material-symbols-outlined">diversity_3</span>
                            </div>
                            <h4 className="text-slate-900 font-bold">Global Connection</h4>
                            <p className="text-sm text-slate-500">Direct mentorship from the Ethereum Foundation and core teams from across the Superchain.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="relative">
                    <div className="aspect-[4/5] rounded-[2.5rem] overflow-hidden border border-white/10 shadow-2xl">
                        ...
                        <div className="absolute bottom-10 left-10 right-10 p-8 rounded-2xl bg-white border border-black/5 shadow-xl">
                            <p className="text-slate-900 font-bold text-xl mb-2">"Scaling the protocol means scaling the people."</p>
