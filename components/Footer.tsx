        ...
        <footer className="bg-white pt-20 pb-10 border-t border-black/5">
            <div className="max-w-7xl mx-auto px-6">
                <div className="grid md:grid-cols-4 gap-12 mb-20">
                    ...
                    <div>
                        <h5 className="text-[#0a0a0c] font-bold mb-6">Explore</h5>
                    ...
                    <div>
                        <h5 className="text-[#0a0a0c] font-bold mb-6">Partners</h5>
                        <div className="flex flex-col gap-4">
                            <div className="flex items-center gap-2 grayscale hover:grayscale-0 transition-all opacity-60 hover:opacity-100">
                                <span className="text-[#0a0a0c] font-bold italic tracking-tighter">Web3Bridge</span>
                            </div>
                            <div className="flex items-center gap-2 grayscale hover:grayscale-0 transition-all opacity-60 hover:opacity-100">
                                <span className="text-[#0a0a0c] font-bold italic tracking-tighter">Upskill Africa</span>
                            </div>
                            <div className="flex items-center gap-2 grayscale hover:grayscale-0 transition-all opacity-60 hover:opacity-100">
                                <span className="text-[#0a0a0c] font-bold italic tracking-tighter">Lagos Eth Hub</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex flex-col md:flex-row justify-between items-center pt-10 border-t border-white/5 gap-6">
                    <p className="text-slate-600 text-xs">© 2026 ETH Research Guild. All rights reserved.</p>
                    <div className="flex gap-6">
                        <a className="text-slate-500 hover:text-[#13ec5b] transition-colors" href="#">
