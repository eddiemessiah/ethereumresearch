        ...
        <section className="py-24 px-6" id="labs">
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-16">
                    ...
                    <h2 className="text-4xl font-black text-slate-900 mb-4">Research Labs</h2>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
                    {/* Agentic Economy */}
                    <div className="group p-8 rounded-2xl bg-white border border-black/5 hover:border-purple-500/50 shadow-sm transition-all hover:shadow-lg">
                        ...
                        <h4 className="text-xl font-bold text-slate-900 mb-2">Agentic Economy</h4>
                        <p className="text-[#13ec5b] text-xs font-bold uppercase tracking-wider mb-3">AI + Crypto</p>
                        <p className="text-slate-600 text-sm leading-relaxed">ERC-8004, x402, and AI agents that can pay for things autonomously.</p>
                    </div>

                    {/* Privacy & Data */}
                    <div className="group p-8 rounded-2xl bg-white border border-black/5 hover:border-emerald-500/50 shadow-sm transition-all hover:shadow-lg">
                        ...
                        <h4 className="text-xl font-bold text-slate-900 mb-2">Privacy & Data</h4>
                        <p className="text-[#13ec5b] text-xs font-bold uppercase tracking-wider mb-3">ZK Proofs</p>
                        <p className="text-slate-600 text-sm leading-relaxed">Zero-knowledge circuits, private payroll, and on-chain data oracles.</p>
                    </div>

                    {/* Decentralized Luma */}
                    <div className="group p-8 rounded-2xl bg-white border border-black/5 hover:border-orange-500/50 shadow-sm transition-all hover:shadow-lg">
                        ...
                        <h4 className="text-xl font-bold text-slate-900 mb-2">Decentralized Luma</h4>
                        <p className="text-[#13ec5b] text-xs font-bold uppercase tracking-wider mb-3">Core Build</p>
                        <p className="text-slate-600 text-sm leading-relaxed">Building our own event platform with SIWE, NFT tickets, and ZK-Email.</p>
                    </div>

                    {/* Open Source */}
                    <div className="group p-8 rounded-2xl bg-white border border-black/5 hover:border-cyan-500/50 shadow-sm transition-all hover:shadow-lg">
                        ...
                        <h4 className="text-xl font-bold text-slate-900 mb-2">Open Source</h4>
                        <p className="text-[#13ec5b] text-xs font-bold uppercase tracking-wider mb-3">Public Goods</p>
                        <p className="text-slate-600 text-sm leading-relaxed">Drips Protocol, sustainable funding, and contributing to core repos.</p>
                    </div>

                    {/* Financial Inclusion */}
                    <div className="group p-8 rounded-2xl bg-white border border-black/5 hover:border-yellow-500/50 shadow-sm transition-all hover:shadow-lg">
                        ...
                        <h4 className="text-xl font-bold text-slate-900 mb-2">Financial Inclusion</h4>
                        <p className="text-[#13ec5b] text-xs font-bold uppercase tracking-wider mb-3">Stablecoins & BTCfi</p>
                        <p className="text-slate-600 text-sm leading-relaxed">MiniApps, Telegram wallets, and Bitcoin DeFi for emerging markets.</p>
                    </div>
                </div>
            </div>
        </section>
