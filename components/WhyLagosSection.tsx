        ...
        <section className="py-24 px-6 border-t border-white/5">
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-20">
                    ...
                    <h3 className="text-4xl md:text-5xl font-black text-slate-900">Why Lagos, Nigeria?</h3>
                </div>

                <div className="grid md:grid-cols-3 gap-12">
                    <div className="space-y-4">
                        <h4 className="text-2xl font-bold text-slate-900">01. High Adoption</h4>
                    ...
                    <div className="space-y-4">
                        <h4 className="text-2xl font-bold text-slate-900">02. Tech Hub</h4>
                        <p className="text-slate-600 leading-relaxed">
                    ...
                    <div className="space-y-4">
                        <h4 className="text-2xl font-bold text-slate-900">03. Practical Challenges</h4>
                        <p className="text-slate-600 leading-relaxed">
                ...
                <div className="mt-20 aspect-[21/9] rounded-[3rem] overflow-hidden border border-white/10 relative group">
                    ...
                    <div className="absolute bottom-12 left-12">
                        <div className="flex items-center gap-4 bg-white border border-black/5 shadow-lg px-6 py-3 rounded-2xl">
                            <span className="material-symbols-outlined text-[#13ec5b]">location_on</span>
                            <span className="text-slate-900 font-bold">Lagos Metropolis, Nigeria</span>
                        </div>
                    </div>
                </div>
            </div>
